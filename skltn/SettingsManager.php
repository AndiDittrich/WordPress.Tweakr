...
class SettingsManager{
    ...
    public function __construct($pluginConfig){
        ...
        $this->_config = array_merge($this->_defaultConfig, get_option('tweakr-options', array()));
    }
    
    // register settings
    public function registerSettings(){
        register_setting('tweakr-settings-group', 'tweakr-options', array($this, 'validateSettings'));
    }
    ...
    public function setOption($key, $value){
        ...
        if (isset($this->_config[$key])){
            ...
            update_option('tweakr-options', $this->_config);
        }
    }
