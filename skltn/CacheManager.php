...
class CacheManager{
    ...
    public function __construct(){
        ...
        // default cache
        $this->_cachePath = TWEAKR_PLUGIN_PATH.'/cache/';
        $this->_cacheUrl = plugins_url('/tweakr/cache/');

        // generate static url
        self::$__url = $this->_cacheUrl . $this->_prefix;

        // get last update hash
        self::$__cacheHash = get_option('tweakr-cache-hash', '0A0B0C');
    }
    ...
    public function clearCache($clearAll = false){
        ...
        update_option('tweakr-cache-hash', self::$__cacheHash, true);
    }
